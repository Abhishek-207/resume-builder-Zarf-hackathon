  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} className="scroll-smooth">
      <nav className="sticky top-0 z-20 h-14 w-full bg-resume-800 flex py-2.5 px-4 xl:px-60 items-center shadow-level-8dp">
        ...
        <div className="flex-auto flex justify-between items-center ml-5">
          ...
          <NavBarActions>
            ...
            <a
              href={'https://github.com/Abhishek-207/resume-builder-Zarf-hackathon'}
              target="_blank"
            ...
            <div className="col-span-12 sm:col-span-8">
              ...
              <div className="flex mb-10">
                ...
                <p className="text-lg ml-3 text-resume-800">
                  &ldquo;An Open Sourse Project buid by&rdquo;
                  <br />
                  —Abhishek Singh
                </p>
              </div>
      ...
      >
        ...
        This is a open source website build by <strong>Abhisek singh</strong>, as the participating entry in web develpment Hackathon, organised under flagship collage fest<strong> Zarf</strong> of ZHCET, AMU
        </p>
